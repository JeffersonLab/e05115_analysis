      subroutine e_dc_ntuple_shutdown(ABORT,err)
*----------------------------------------------------------------------
*     
...
*     
      character*17 here
      parameter (here='e_dc_ntuple_shutdown')
*     
      logical ABORT
      character*(*) err
*     
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        e_dc_ntuple_exists= .FALSE.
        e_dc_ntuple_ID= 0
        e_dc_ntuple_name= ' '
        e_dc_ntuple_IOchannel= 0
        e_dc_ntuple_file= ' '
        e_dc_ntuple_title= ' '
        e_dc_ntuple_directory= ' '
        e_dc_ntuple_size= 0
        do m=1,EMAX_Ntuple_size
          e_dc_ntuple_tag(m)= ' '
          e_dc_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(e_dc_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') 
     &     id,io,e_dc_ntuple_file
