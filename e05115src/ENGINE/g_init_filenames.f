...
*-    Modified   17-Dec-1999 Jinghua Liu; Set default config file name,
*-               in case there is no EVVIRONMENT variable, ENGINE still works.
*
* Revision 2.2 2004/03/01 17: Miyoshi
*
* Revision 2.1   1999/12/17 14:30:34  jinghua
* Set default config file name.
*
* Revision 2.0   1999/07/02 13:45:00 jinghua
...
*
      ...
      e_threshold_output_filename = ' '
      g_pedestal_output_filename = ' '
      h_pedestal_output_filename = ' '
      e_pedestal_output_filename = ' '
*
...
*
C      ABORT= g_config_filename.EQ.' '
C      IF(ABORT) THEN
C        err= here//':blank environmental variable '//env_var
C        RETURN
C      ENDIF

      if(g_config_filename.EQ.' ')
     $     g_config_filename = 'REPLAY.PARM'
