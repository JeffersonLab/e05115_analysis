...
*     
*     Revision 2.0   1999/07/06 11:24:00  jinghua
...
*     
      ...
      character*(*) err
*     
      logical HES_ABORT,HKS_ABORT,COIN_ABORT,SCAL_ABORT
      character*132 HES_err,HKS_err,COIN_err,SCAL_err
*     
      integer hit,chan,roc,slot,multi
*
...
*
      call e_reset_event(HES_ABORT,HES_err)
*     
      call h_reset_event(HKS_ABORT,HKS_err)
*     
      call C_reset_event(COIN_ABORT,COIN_err)
*     
      abort = hes_abort.or.hks_abort.or.coin_abort.or.scal_abort
*
      IF(ABORT) then
         err= COIN_err
