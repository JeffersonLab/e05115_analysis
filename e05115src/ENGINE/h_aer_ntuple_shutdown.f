      subroutine h_aer_ntuple_shutdown(ABORT,err)
*----------------------------------------------------------------------
*
*     Final shutdown of the HKS aer Ntuple
*
*     Purpose : Flushes and closes the HKS aer Ntuple
*
...
*
      character*17 here
      parameter (here='h_aer_ntuple_shutdown')
*
      logical ABORT
      character*(*) err
*
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        h_aer_ntuple_exists= .FALSE.
        h_aer_ntuple_ID= 0
        h_aer_ntuple_name= ' '
        h_aer_ntuple_IOchannel= 0
        h_aer_ntuple_file= ' '
        h_aer_ntuple_title= ' '
        h_aer_ntuple_directory= ' '
        h_aer_ntuple_size= 0
        do m=1,HMAX_Ntuple_size
          h_aer_ntuple_tag(m)= ' '
          h_aer_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(h_aer_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') id,io,h_aer_ntuple_file
