      subroutine h_ch_ntuple_shutdown(ABORT,err)
*----------------------------------------------------------------------
*
*     Final shutdown of the HKS Cherenkov Ntuple
*
*     Purpose : Flushes and closes the HKS Cherenkov Ntuple
*
...
*
      character*17 here
      parameter (here='h_ch_ntuple_shutdown')
*
      logical ABORT
      character*(*) err
*
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        h_ch_ntuple_exists= .FALSE.
        h_ch_ntuple_ID= 0
        h_ch_ntuple_name= ' '
        h_ch_ntuple_IOchannel= 0
        h_ch_ntuple_file= ' '
        h_ch_ntuple_title= ' '
        h_ch_ntuple_directory= ' '
        h_ch_ntuple_size= 0
        do m=1,HMAX_Ntuple_size
          h_ch_ntuple_tag(m)= ' '
          h_ch_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(h_ch_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') id,io,h_ch_ntuple_file
