...
*----------------------------------------------------------------------
*
*     Final shutdown of the HKS DC Ntuple
*
*     Purpose : Flushes and closes the HKS Ntuple
*
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        h_dc_ntuple_exists= .FALSE.
        h_dc_ntuple_ID= 0
        h_dc_ntuple_name= ' '
        h_dc_ntuple_IOchannel= 0
        h_dc_ntuple_file= ' '
        h_dc_ntuple_title= ' '
        h_dc_ntuple_directory= ' '
        h_dc_ntuple_size= 0
        do m=1,HMAX_Ntuple_size
          h_dc_ntuple_tag(m)= ' '
          h_dc_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(h_dc_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') id,io,h_dc_ntuple_file
