      subroutine h_luc_ntuple_shutdown(ABORT,err)
*----------------------------------------------------------------------
*
*     Final shutdown of the HKS luc Ntuple
*
*     Purpose : Flushes and closes the HKS luc Ntuple
*
...
*
      character*17 here
      parameter (here='h_luc_ntuple_shutdown')
*
      logical ABORT
      character*(*) err
*
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        h_luc_ntuple_exists= .FALSE.
        h_luc_ntuple_ID= 0
        h_luc_ntuple_name= ' '
        h_luc_ntuple_IOchannel= 0
        h_luc_ntuple_file= ' '
        h_luc_ntuple_title= ' '
        h_luc_ntuple_directory= ' '
        h_luc_ntuple_size= 0
        do m=1,HMAX_Ntuple_size
          h_luc_ntuple_tag(m)= ' '
          h_luc_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(h_luc_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') id,io,h_luc_ntuple_file
