      subroutine h_pid_ntuple_shutdown(ABORT,err)
*----------------------------------------------------------------------
*
*     Final shutdown of the HKS pid Ntuple
*
*     Purpose : Flushes and closes the HKS pid Ntuple
*
...
*
      character*17 here
      parameter (here='h_pid_ntuple_shutdown')
*
      logical ABORT
      character*(*) err
*
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        h_pid_ntuple_exists= .FALSE.
        h_pid_ntuple_ID= 0
        h_pid_ntuple_name= ' '
        h_pid_ntuple_IOchannel= 0
        h_pid_ntuple_file= ' '
        h_pid_ntuple_title= ' '
        h_pid_ntuple_directory= ' '
        h_pid_ntuple_size= 0
        do m=1,HMAX_Ntuple_size
          h_pid_ntuple_tag(m)= ' '
          h_pid_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(h_pid_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') id,io,h_pid_ntuple_file
