...
* for E01-011
* Revision 2.0   2000/02/28 17:22:01 jinghua
* (JLiu) removed sos sieve slit ntuple
*
...
*--------------------------------------------------------
      ...
      ABORT = .FALSE.
*
      call r_hks_data_structures

      call r_hks_filenames
...
*
      ...
      ABORT= ABORT .or. FAIL
*
C      call s_sv_nt_register(FAIL,why)  ! Remove this when ctp files fixed
