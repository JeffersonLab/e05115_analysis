      subroutine h_scin_ntuple_shutdown(ABORT,err)
*----------------------------------------------------------------------
*
*     Final shutdown of the HKS scin Ntuple
*
*     Purpose : Flushes and closes the HKS scin Ntuple
*
...
*
      character*17 here
      parameter (here='h_scin_ntuple_shutdown')
*
      logical ABORT
      character*(*) err
*
...
*
      ...
      IF(ABORT) THEN
        ...
        EndIf
        h_scin_ntuple_exists= .FALSE.
        h_scin_ntuple_ID= 0
        h_scin_ntuple_name= ' '
        h_scin_ntuple_IOchannel= 0
        h_scin_ntuple_file= ' '
        h_scin_ntuple_title= ' '
        h_scin_ntuple_directory= ' '
        h_scin_ntuple_size= 0
        do m=1,HMAX_Ntuple_size
          h_scin_ntuple_tag(m)= ' '
          h_scin_ntuple_contents(m)= 0.
        enddo
        RETURN
      ENDIF
*
      ...
      call HCDIR(h_scin_ntuple_directory,' ')      !goto Ntuple directory
*
      write(msg,'("closing ID#",i5," IO#",i3," ",a)') id,io,h_scin_ntuple_file
